<div class="shopping-cart max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="md:w-1/2">
                <div class="bg-white rounded-xl shadow-md overflow-hidden">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-6 pb-2 border-b border-gray-200">Resumen del pedido</h3>
                        ...
                        <div class="flex justify-between mb-6 text-gray-600">
                            <span>Envío:</span>
                            <span>Calculado en la pantalla de pago</span>
                        </div>
    ...
    @else
        <div class="bg-white rounded-xl shadow-md overflow-hidden text-center py-16">
            ...
            <p class="mt-2 text-gray-600">Parece que aún no has añadido ningún producto a tu carrito.</p>
            <div class="mt-6">
                <a 
