        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
                    ...
                    <div class="py-6">
                        @if($product->isFree())
                            <div class="bg-blue-50 rounded-xl p-4 mb-6">
                                <p class="text-2xl font-bold text-blue-600">Descarga Gratuita</p>
                                <p class="text-gray-600 mt-1">Disfruta de este producto sin costo</p>
                        ...
                        @elseif($product->isDonationBased())
                            <div class="bg-purple-50 rounded-xl p-4 mb-6">
                                <h4 class="text-lg font-semibold text-purple-800 mb-2">Apoya al Creador</h4>
                                <p class="text-gray-600 mb-4">Paga lo que quieras (mínimo ${{ number_format($product->minimum_price, 2) }})</p>
                                
                                <form action="{{ route('cart.add', $product) }}" method="POST" class="space-y-4">
                                    @csrf
                                    <div class="flex items-center space-x-3">
                                        <span class="text-gray-700 font-medium">Tu Precio:</span>
                                        <div class="relative">
            ...
            @isset($product->inventoryLogs)
                <div class="bg-gray-50 p-8 border-t border-gray-200">
                    <h3 class="text-xl font-semibold text-gray-900 mb-4">Historial de Inventario</h3>
                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Cambio</th>
                                    <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Razón</th>
                                </tr>
                            </thead>
